...
-- changeset Charvit:pokemon-table
...
-- changeset Charvit:pokemon-table-power-deleted
ALTER TABLE pokemon DROP COLUMN IF EXISTS power;

-- changeset Charvit:pokemon-table-power-added
ALTER TABLE pokemon ADD COLUMN power BIGINT NULL;

-- changeset Charvit:pokemon-table-fk-connect-master-power
ALTER TABLE pokemon ADD CONSTRAINT pokemon_FK FOREIGN KEY (power) REFERENCES power(id);

-- changeset Charvit:master-data-power-inserted
